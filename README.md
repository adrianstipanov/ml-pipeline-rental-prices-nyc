...
Go to [https://github.com/adrianstipanov/ml-pipeline-rental-prices-nyc](https://github.com/adrianstipanov/ml-pipeline-rental-prices-nyc)
and click on `Fork` in the upper right corner. This will create a fork in your Github account, i.e., a copy of the
repository that is under your control. Now clone the repository locally so you can start working on it:

```
git clone https://github.com/[your github username]/ml-pipeline-rental-prices-nyc.git
```

and go into the repository:

```
cd ml-pipeline-rental-prices-nyc
```
